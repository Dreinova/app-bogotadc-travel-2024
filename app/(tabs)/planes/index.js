          ...
          <View style={{ paddingHorizontal: 20, flex: 1 }}>
            ...
            >
              <Slider
                ...
                minimumTrackTintColor="#35498e"
                thumbTintColor="#35498e"
              />
              <View
                style={{
      ...
      <ImageBackground>
        ...
        >
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable
                onPress={() => router.navigate(`(tabs)/planes/${item.nid}`)}
                style={[
                  {

      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            ...
            style={{ width: windowWidth - 20, height: 155, borderRadius:20, overflow:'hidden', marginBottom:10 }}
          >
            <ImageBackground
              style={{ flex: 1 }}
              source={{

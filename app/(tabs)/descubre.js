...
`}
        ...
        ref={flatListRef}
          ...
          renderItem={({ item }) => (
            <CardAtractivoBig
              onPress={() => router.navigate(`(tabs)/atractivos/${item.nid}`)}
              title={item.title}
              image={

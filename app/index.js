...
const LoadingScreen = () => {
  return (
   ...
   <Image source={require('../assets/images/loading.gif')} style={{width: 200,resizeMode:'contain'}} />
      </View>
    </ImageBackground>
  );
};
